...
エージェントの作成を通じて、ナレッジを活用した回答の生成、会話フローの制御、ユーザーのリクエストに応じたデータの作成・取得方法を学習します。
...
6. [Device Assistant にデバイス交換申請機能を実装する](docs/15-build-device-replacement-request.md)
7. [Microsoft 365 Copilot でエージェントをテストする](docs/20-test-agent-in-m365-copilot.md)
